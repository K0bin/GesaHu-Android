        ...
        return with(parent.context) {
            ...
            if (parent.width / parent.context.displayMetrics.density < 680) {
                relativeLayout {
                    ...
                    layoutParams = RecyclerView.LayoutParams(matchParent, tileHeight)
