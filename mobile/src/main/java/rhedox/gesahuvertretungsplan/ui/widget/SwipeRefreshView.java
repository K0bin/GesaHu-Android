...
/**
 * Created by Robin on 01.03.2016.
 */
    public class SwipeRefreshView extends ViewGroup implements NestedScrollingParent,
    ...
    public void setColorSchemeResources(@ColorRes int... colorResIds) {
        ...
        for (int i = 0; i < colorResIds.length; i++) {
            ContextCompat.getColor(getContext(), colorResIds[i]);
        }
